    ...
    <>
      ...
      <div className="wrapper__text--bottom">
        ...
        <p>
          ...
          освоить этот ценный навык. Они позволят вам понять основные концепции
          и принципы работы искуственного интелекта, а также научат практическим
          навыкам и методам их эффективного применения. Курсы адаптированы для
          разных уровней знаний, начиная с вводных курсов и до более продвинутых
          ...
          найти работу или повысить вашу ценность в нынешней компании. Развитие
          искусственного интеллекта и нейронных сетей продолжается, и знание в
          этой области открывает новые возможности и перспективы.
